<template>
    <div id="icons">
        <Breadcrumb :items="['Home|/Dashboards/DashboardV1','UI Elements','Icons']">
        </Breadcrumb>
                    ...
                    <Panel>
                        ...
                        <PanelBody class="icons-box">
                            <div>
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-address-book-o" aria-hidden="true"></i> address-book-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-address-card" aria-hidden="true"></i> address-card</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-address-card-o" aria-hidden="true"></i> address-card-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-bath" aria-hidden="true"></i> bath</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-eercast" aria-hidden="true"></i> eercast</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-envelope-open" aria-hidden="true"></i> envelope-open</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-envelope-open-o" aria-hidden="true"></i> envelope-open-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-etsy" aria-hidden="true"></i> etsy</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-free-code-camp" aria-hidden="true"></i> free-code-camp</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-grav" aria-hidden="true"></i> grav</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-handshake-o" aria-hidden="true"></i> handshake-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-id-badge" aria-hidden="true"></i> id-badge</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-id-card" aria-hidden="true"></i> id-card</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-id-card-o" aria-hidden="true"></i> id-card-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-imdb" aria-hidden="true"></i> imdb</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-linode" aria-hidden="true"></i> linode</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-meetup" aria-hidden="true"></i> meetup</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-microchip" aria-hidden="true"></i> microchip</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-podcast" aria-hidden="true"></i> podcast</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-quora" aria-hidden="true"></i> quora</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-ravelry" aria-hidden="true"></i> ravelry</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-shower" aria-hidden="true"></i> shower</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-snowflake-o" aria-hidden="true"></i> snowflake-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-superpowers" aria-hidden="true"></i> superpowers</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-thermometer-empty" aria-hidden="true"></i> thermometer-empty</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-thermometer-full" aria-hidden="true"></i> thermometer-full</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-thermometer-half" aria-hidden="true"></i> thermometer-half</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-thermometer-quarter" aria-hidden="true"></i> thermometer-quarter</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-thermometer-three-quarters" aria-hidden="true"></i> thermometer-three-quarters</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-user-circle" aria-hidden="true"></i> user-circle</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-user-circle-o" aria-hidden="true"></i> user-circle-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-user-o" aria-hidden="true"></i> user-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-window-close" aria-hidden="true"></i> window-close</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-window-close-o" aria-hidden="true"></i> window-close-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-window-maximize" aria-hidden="true"></i> window-maximize</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-window-minimize" aria-hidden="true"></i> window-minimize</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-window-restore" aria-hidden="true"></i> window-restore</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-wpexplorer" aria-hidden="true"></i> wpexplorer</a>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-angellist"></i> fa-angellist</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="../icon/area-chart">
                                        <i class="fa fa-area-chart"></i> fa-area-chart</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-at"></i> fa-at</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-bell-slash"></i> fa-bell-slash</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-bell-slash-o"></i> fa-bell-slash-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-binoculars"></i> fa-binoculars</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-birthday-cake"></i> fa-birthday-cake</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-bus"></i> fa-bus</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-calculator"></i> fa-calculator</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-cc"></i> fa-cc</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-cc-amex"></i> fa-cc-amex</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-cc-discover"></i> fa-cc-discover</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-cc-mastercard"></i> fa-cc-mastercard</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-cc-stripe"></i> fa-cc-stripe</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-cc-visa"></i> fa-cc-visa</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-copyright"></i> fa-copyright</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-eyedropper"></i> fa-eyedropper</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-futbol-o"></i> fa-futbol-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-google-wallet"></i> fa-google-wallet</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-ils"></i> fa-ils</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-ioxhost"></i> fa-ioxhost</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-lastfm"></i> fa-lastfm</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-lastfm-square"></i> fa-lastfm-square</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-line-chart"></i> fa-line-chart</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-meanpath"></i> fa-meanpath</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-newspaper-o"></i> fa-newspaper-o</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-paint-brush"></i> fa-paint-brush</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-paypal"></i> fa-paypal</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-pie-chart"></i> fa-pie-chart</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-plug"></i> fa-plug</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-slideshare"></i> fa-slideshare</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-toggle-off"></i> fa-toggle-off</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-toggle-on"></i> fa-toggle-on</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-trash"></i> fa-trash</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-tty"></i> fa-tty</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-twitch"></i> fa-twitch</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-wifi"></i> fa-wifi</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="">
                                        <i class="fa fa-yelp"></i> fa-yelp</a>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-behance"></i> fa-behance</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-behance-square"></i> fa-behance-square</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-bomb"></i> fa-bomb</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-building"></i> fa-building</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-car"></i> fa-car</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-child"></i> fa-child</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-circle-o-notch"></i> fa-circle-o-notch</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-circle-thin"></i> fa-circle-thin</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-codepen"></i> fa-codepen</a>
                                </div>
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                ...
                                <div class="infont col-md-3 col-sm-4">
                                    <a href="#">
                                        <i class="fa fa-yahoo"></i> fa-yahoo</a>
                                </div>

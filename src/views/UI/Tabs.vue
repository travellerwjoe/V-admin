            ...
            <div class="col-lg-6">
                ...
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#tab-1"> This is tab</a>
                        </li>
                        <li class="">
            ...
            <div class="col-lg-6">
                <div class="tabs-container">
                    ...
                    <div class="tabs-left">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#tab-6"> This is tab</a>
                            </li>
                            <li class="">
            ...
            <div class="col-lg-6">
                <div class="tabs-container">
                    <div class="tabs-right">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#tab-8"> This is tab</a>
                            </li>
                            <li class="">
                                <a data-toggle="tab" href="#tab-9">This is second tab</a>
                            </li>
                        </ul>
                        <div class="tab-content ">
